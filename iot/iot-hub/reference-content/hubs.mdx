...
Upon connecting a not-yet-known device with a valid certificate, your Hub can automatically add it to it's device list if you enable the auto-provisioning feature, otherwise connection will be denied.
...
For more information on how to receive events, please head to [the HOWTO](/iot/iot-hub/howto/handle-events).

<Message type="important">

FILL THE HANDLE EVENT HOWTO
...
<Navigation title="See Also">
  ...
  <NextButton to="/iot/iot-hub/reference-content/devices/">Reference documentation for Devices</NextButton>
</Navigation>
